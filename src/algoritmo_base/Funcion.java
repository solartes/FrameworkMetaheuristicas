...
/**
 * Clase abstracta Funcion,
 * Atributos
 * 
 *  rangoMin: Rango minimo en la cual esta definida la funcion.
 *  rangoMax: Rango maximo en la cual esta definida la funcion.
 *  dimensiones: Numero de dimensiones que tendra la funcion.
 * 
